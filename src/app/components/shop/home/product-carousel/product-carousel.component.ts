...
export class ProductCarouselComponent implements OnInit {
  ...
  constructor(public domSanitizer: DomSanitizer,private dialog: MatDialog, private router: Router, private cartService: CartService, private productService: ProductService, private wishlistService: WishlistService) { }
